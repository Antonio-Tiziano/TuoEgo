<div class="navbar mt-4 xl:mt-8 bg-base-100">
    <div class="navbar-start ml-4 md:ml-6 2xl:ml-24 avatar">
        <a href="{{ route('home') }}" class="w-12 m-2 text-xl">
            <img id="logo" class="w-20" src="storage/img/pin.png" alt="">
        </a>
    </div>
    ...
    <div class="navbar-end mr-4 md:mr-6 2xl:mr-24">
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        ...
        const updateLogo = () => {
            if (themeController.checked) {
                ...
                logo.src = 'storage/img/pin-white.png';
            } else {
                // Light theme is active
                logo.src = 'storage/img/pin.png';
            }
        };
        ...
        themeController.addEventListener('change', updateLogo);
    });
</script>
